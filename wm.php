...
// Fetch category
$category_id = 2; // Assuming '2' corresponds to the desired category
        ...
        <div class="col-6 col-md-3 mb-3 d-flex">
            <div class="card d-flex flex-column">
                ...
                <div class="card-body " >
                    ...
                    <!-- <p class="card-text mb-0"><?php echo htmlspecialchars($site_name); ?></p> -->
                    <p class="card-text font-weight-bold mb-0 h-0">Rs.<?php echo htmlspecialchars($product['price']); ?></p>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
